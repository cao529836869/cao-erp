...
export function addWarehouse(data) {
  return request({ url: '/erp/warehouse', method: 'post', data })
}

export function updateWarehouse(data) {
  return request({ url: '/erp/warehouse', method: 'put', data })
}
...
export function optionselectWarehouse() {
  return request({ url: '/erp/warehouse/optionselect', method: 'get' })
}
